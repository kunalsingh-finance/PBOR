...
def run_month_end(
    ...
    portfolio_benchmark_map = policy.get("portfolio_benchmark_map", {})
    ...
    try:
        ...
        attribution = compute_monthly_attribution(
            ...
            portfolio_benchmark_map=portfolio_benchmark_map if isinstance(portfolio_benchmark_map, dict) else {},
